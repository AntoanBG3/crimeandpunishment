...
def test_event_manager_error_cooldown_and_gossip_paths():
    ...
    game = SimpleNamespace(
        ...
        world_manager=SimpleNamespace(get_current_time_period=lambda: "Morning"),
...
def test_event_manager_triggers_and_story_actions():
    ...
    game = SimpleNamespace(
        ...
        world_manager=SimpleNamespace(get_current_time_period=MagicMock(return_value="Afternoon")),
